...
# -*- coding : utf8 -*-
"""
Ce script a pour but de modifier les données d'une personne
"""
...
class Application(tk.Tk):
    ...
    def create_widgets(self):
        ...
        headers = [ ("Identifiant", 100),
            ...
            ("Rue", 150), ("Appartement", 100), ("N° Bati", 60),("Hall", 60),("Code Postal", 90), ("Commune", 120)
        ]
    ...
    def __init__(self, parent, values):
        ...
        addr_btn = tk.Button(self, text="Modifier l'adresse",
                           command=lambda: self.open_address_edit(self.values[0],
                                         self.values[8:] if len(self.values) > 8 else [""]*10))
