...
# -*- coding : utf8 -*-
"""
Ce script a pour but d'acter une adhesion
"""
    ...
    def update_adhesion(self, id_personne, new_values):
        ...
        try:
            with conn.cursor() as cur:
                ...
                conn.commit()
                messagebox.showinfo("Succès", f"Modification de l'adhésion enregistrée.\nTarif à payer : {prix_tarif}€")
...
class EditWindow(tk.Toplevel):
    def __init__(self, parent, values):
        ...
        ttk.Label(main_frame, text="Date d'adhésion (JJ/MM/AAAA) :").grid(row=5, column=0, padx=5, pady=5, sticky="e")
