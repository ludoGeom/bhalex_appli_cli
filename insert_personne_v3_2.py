...
def connexion(nom_pers=None, geocodage_bon=None, address=None):
    ...
    def get_form_data():
        try:
            ...
            if not entry_widgets["entry_nom_pers"].get():
            ...
            try:
                ...
                cur.execute(
                    ...
                    VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, 
                            public.ST_SetSRID(public.ST_Point(%s::double precision, %s::double precision), 4326))
                    RETURNING id_adresse;
                    """,
                    (type_rue, num_rue, complement_num, article_rue, nom_rue, num_bati, hall,
                     num_appart, code_postal, commune,
